...
export class Backend implements backendInterface {
    ...
    async getAllPendingTransactions(): Promise<Array<Transaction>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPendingTransactions();
    ...
    async getTransactionRecord(arg0: bigint): Promise<Transaction | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getTransactionRecord(arg0);
    ...
    async submitDeposit(arg0: number, arg1: string, arg2: ExternalBlob): Promise<SubmitDepositResult> {
        if (this.processError) {
            try {
                ...
                return from_candid_SubmitDepositResult_n41(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
...
function from_candid_EntryFeeType_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _EntryFeeType): EntryFeeType {
...
function from_candid_RoomJoinStatus_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RoomJoinStatus): RoomJoinStatus {
    return from_candid_variant_n23(_uploadFile, _downloadFile, value);
}
function from_candid_RoomType_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RoomType): RoomType {
    return from_candid_variant_n25(_uploadFile, _downloadFile, value);
}
function from_candid_Room_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Room): Room {
    return from_candid_record_n21(_uploadFile, _downloadFile, value);
}
function from_candid_SubmitDepositResult_n41(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SubmitDepositResult): SubmitDepositResult {
...
async function from_candid_Transaction_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Transaction): Promise<Transaction> {
...
async function from_candid_opt_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Transaction]): Promise<Transaction | null> {
    return value.length === 0 ? null : await from_candid_Transaction_n11(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        joinStatus: from_candid_RoomJoinStatus_n22(_uploadFile, _downloadFile, value.joinStatus),
        entryFee: value.entryFee,
        roomType: from_candid_RoomType_n24(_uploadFile, _downloadFile, value.roomType),
...
function from_candid_record_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        name: value.name,
        entryFeeType: from_candid_EntryFeeType_n29(_uploadFile, _downloadFile, value.entryFeeType),
        entryFee: value.entryFee,
...
function from_candid_variant_n42(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "utrDuplicate" in value ? {
        __kind__: "utrDuplicate",
        utrDuplicate: value.utrDuplicate
    } : "success" in value ? {
        __kind__: "success",
        success: value.success
    } : value;
}
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Transaction>): Promise<Array<Transaction>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Transaction_n11(_uploadFile, _downloadFile, x)));
}
function from_candid_vec_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Room>): Array<Room> {
    return value.map((x)=>from_candid_Room_n20(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Tournament>): Array<Tournament> {
